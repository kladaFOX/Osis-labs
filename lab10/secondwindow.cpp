...
void SecondWindow::paintEvent(QPaintEvent *event) {
    if(isDraw)
    {
        ...
        switch(figure){
            case 1: paint->drawPolygon(diamond, 4); break;
            case 2: paint->drawEllipse(150, 150, 100, 100); break;
            case 3: paint->drawRect(150, 150, 100, 100); break;
            case 4: paint->drawPolygon(star, 10); break;
        }
